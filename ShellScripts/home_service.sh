#!/bin/sh
xterm  -e  " export TURTLEBOT_GAZEBO_WORLD_FILE=$(find turtlebot_simulator)/World/gazebo.world && source ../../devel/setup.bash && roslaunch ../turtlebot_simulator/turtlebot_gazebo/launch/turtlebot_world.launch world_file:=$(find turtlebot_simulator)/World/gazebo2.world" &
sleep 5
